...
public class SteamedMilkIngridient extends DrinkDecarator
{
    private final IngredientType ingredientType = IngredientType.STEAMED_MILK;
    public SteamedMilkIngridient(Drink drink)
    {
        super(drink);
    }
